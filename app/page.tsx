...
import React, { useEffect, useState, useMemo, CSSProperties, useRef } from "react";
import Link from "next/link";
import { ArrowRight, Sparkles, Zap, Globe, Infinity, Rocket, ChevronLeft, ChevronRight, ExternalLink, Users, BookOpen, Award } from "lucide-react";
...
const HomePage: React.FC<HomePageProps> = ({ mode }) => {
  ...
  const [isDarkMode, setIsDarkMode] = useState<boolean>(mode === "dark" || mode === "#18191a");
